module pwm_ctrl (VGND,
 ...
 sky130_fd_sc_hd__decap_3 FILLER_0_0_37 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_3 FILLER_0_0_40 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_3 FILLER_0_0_43 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_3 FILLER_0_0_46 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_3 FILLER_0_0_49 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_3 FILLER_0_0_52 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__inv_2 _44_ (.A(net5),
    ...
    .VPWR(VPWR),
    .Y(_08_));
 sky130_fd_sc_hd__inv_2 _45_ (.A(net7),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_09_));
 sky130_fd_sc_hd__or2b_1 _46_ (.A(\counter[7] ),
    .B_N(net8),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_10_));
 sky130_fd_sc_hd__or2b_1 _47_ (.A(\counter[5] ),
    .B_N(net6),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_11_));
 sky130_fd_sc_hd__or2b_1 _48_ (.A(\counter[4] ),
    .B_N(net5),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_12_));
 sky130_fd_sc_hd__o2111ai_1 _49_ (.A1(\counter[6] ),
    .A2(_09_),
    .B1(_10_),
    .C1(_11_),
    .D1(_12_),
    ...
    .VPWR(VPWR),
    .Y(_13_));
 sky130_fd_sc_hd__and2b_1 _50_ (.A_N(net8),
    .B(\counter[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_14_));
 sky130_fd_sc_hd__inv_2 _51_ (.A(net6),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_15_));
 sky130_fd_sc_hd__a22o_1 _52_ (.A1(\counter[6] ),
    .A2(_09_),
    .B1(\counter[5] ),
    .B2(_15_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_16_));
 sky130_fd_sc_hd__a2111oi_1 _53_ (.A1(_08_),
    .A2(\counter[4] ),
    .B1(_13_),
    .C1(_14_),
    .D1(_16_),
    ...
    .VPWR(VPWR),
    .Y(_17_));
 sky130_fd_sc_hd__inv_2 _54_ (.A(\counter[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_18_));
 sky130_fd_sc_hd__and2b_1 _55_ (.A_N(\counter[3] ),
    .B(net4),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_19_));
 sky130_fd_sc_hd__and2b_1 _56_ (.A_N(net4),
    .B(\counter[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_20_));
 sky130_fd_sc_hd__xor2_1 _57_ (.A(\counter[2] ),
    .B(net3),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_21_));
 sky130_fd_sc_hd__or3_1 _58_ (.A(_19_),
    .B(_20_),
    .C(_21_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_22_));
 sky130_fd_sc_hd__or2b_1 _59_ (.A(\counter[1] ),
    .B_N(net2),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_23_));
 sky130_fd_sc_hd__or2b_1 _60_ (.A(net2),
    .B_N(\counter[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_24_));
 sky130_fd_sc_hd__o211ai_1 _61_ (.A1(net1),
    .A2(_18_),
    .B1(_23_),
    .C1(_24_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_25_));
 sky130_fd_sc_hd__a211oi_1 _62_ (.A1(net1),
    .A2(_18_),
    .B1(_22_),
    .C1(_25_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_26_));
 sky130_fd_sc_hd__o21a_1 _63_ (.A1(\counter[6] ),
    .A2(_09_),
    .B1(_10_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_27_));
 sky130_fd_sc_hd__a21oi_1 _64_ (.A1(_27_),
    .A2(_16_),
    .B1(_14_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_28_));
 sky130_fd_sc_hd__and2_1 _65_ (.A(_13_),
    .B(_28_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_29_));
 sky130_fd_sc_hd__nor3b_1 _66_ (.A(\counter[2] ),
    .B(_20_),
    .C_N(net3),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_30_));
 sky130_fd_sc_hd__a21oi_1 _67_ (.A1(_23_),
    .A2(_25_),
    .B1(_22_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_31_));
 sky130_fd_sc_hd__o31a_1 _68_ (.A1(_19_),
    .A2(_30_),
    .A3(_31_),
    .B1(net11),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_32_));
 sky130_fd_sc_hd__o2bb2a_1 _69_ (.A1_N(net12),
    .A2_N(_26_),
    .B1(_29_),
    .B2(_32_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(net10));
 sky130_fd_sc_hd__nor2_1 _70_ (.A(net13),
    .B(net9),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_00_));
 sky130_fd_sc_hd__a21oi_1 _71_ (.A1(\counter[1] ),
    .A2(net17),
    .B1(net9),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_33_));
 sky130_fd_sc_hd__o21a_1 _72_ (.A1(\counter[1] ),
    .A2(net13),
    .B1(_33_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_01_));
 sky130_fd_sc_hd__a21oi_1 _73_ (.A1(\counter[1] ),
    .A2(net13),
    .B1(net19),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_34_));
 sky130_fd_sc_hd__a31o_1 _74_ (.A1(\counter[2] ),
    .A2(\counter[1] ),
    .A3(net17),
    .B1(net9),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_35_));
 sky130_fd_sc_hd__nor2_1 _75_ (.A(_34_),
    .B(_35_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_02_));
 sky130_fd_sc_hd__a31oi_1 _76_ (.A1(\counter[2] ),
    .A2(\counter[1] ),
    .A3(\counter[0] ),
    .B1(net14),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_36_));
 sky130_fd_sc_hd__and4_1 _77_ (.A(\counter[3] ),
    .B(\counter[2] ),
    .C(\counter[1] ),
    .D(\counter[0] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_37_));
 sky130_fd_sc_hd__nor3_1 _78_ (.A(net9),
    .B(_36_),
    .C(_37_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_03_));
 sky130_fd_sc_hd__a21oi_1 _79_ (.A1(\counter[4] ),
    .A2(_37_),
    .B1(net9),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_38_));
 sky130_fd_sc_hd__o21a_1 _80_ (.A1(net20),
    .A2(_37_),
    .B1(_38_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_04_));
 sky130_fd_sc_hd__a21oi_1 _81_ (.A1(\counter[4] ),
    .A2(_37_),
    .B1(net16),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_39_));
 sky130_fd_sc_hd__and3_1 _82_ (.A(\counter[5] ),
    .B(\counter[4] ),
    .C(_37_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_40_));
 sky130_fd_sc_hd__nor3_1 _83_ (.A(net9),
    .B(_39_),
    .C(_40_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_05_));
 sky130_fd_sc_hd__and2_1 _84_ (.A(\counter[6] ),
    .B(_40_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_41_));
 sky130_fd_sc_hd__nor2_1 _85_ (.A(net9),
    .B(_41_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_42_));
 sky130_fd_sc_hd__o21a_1 _86_ (.A1(net18),
    .A2(_40_),
    .B1(_42_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_06_));
 sky130_fd_sc_hd__a21oi_1 _87_ (.A1(net15),
    .A2(_41_),
    .B1(net9),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_43_));
 sky130_fd_sc_hd__o21a_1 _88_ (.A1(net15),
    .A2(_41_),
    .B1(_43_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_07_));
 sky130_fd_sc_hd__dfxtp_2 _89_ (.CLK(clknet_1_1__leaf_clk),
    .D(_00_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\counter[0] ));
 sky130_fd_sc_hd__dfxtp_1 _90_ (.CLK(clknet_1_1__leaf_clk),
    .D(_01_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\counter[1] ));
 sky130_fd_sc_hd__dfxtp_1 _91_ (.CLK(clknet_1_1__leaf_clk),
    .D(_02_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\counter[2] ));
 sky130_fd_sc_hd__dfxtp_1 _92_ (.CLK(clknet_1_1__leaf_clk),
    .D(_03_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\counter[3] ));
 sky130_fd_sc_hd__dfxtp_1 _93_ (.CLK(clknet_1_0__leaf_clk),
    .D(_04_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\counter[4] ));
 sky130_fd_sc_hd__dfxtp_1 _94_ (.CLK(clknet_1_0__leaf_clk),
    .D(_05_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\counter[5] ));
 sky130_fd_sc_hd__dfxtp_1 _95_ (.CLK(clknet_1_0__leaf_clk),
    .D(_06_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\counter[6] ));
 sky130_fd_sc_hd__dfxtp_1 _96_ (.CLK(clknet_1_0__leaf_clk),
    .D(_07_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold6 (.A(\counter[6] ),
    ...
    .VPWR(VPWR),
    .X(net18));
 sky130_fd_sc_hd__dlygate4sd3_1 hold7 (.A(\counter[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net19));
 sky130_fd_sc_hd__dlygate4sd3_1 hold8 (.A(\counter[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net20));
 sky130_fd_sc_hd__clkbuf_1 input1 (.A(duty[0]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net1));
 sky130_fd_sc_hd__clkbuf_1 input2 (.A(duty[1]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net2));
 sky130_fd_sc_hd__buf_1 input3 (.A(duty[2]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net3));
 sky130_fd_sc_hd__clkbuf_1 input4 (.A(duty[3]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net4));
 sky130_fd_sc_hd__buf_1 input5 (.A(duty[4]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net5));
 sky130_fd_sc_hd__buf_1 input6 (.A(duty[5]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net6));
 sky130_fd_sc_hd__clkbuf_1 input7 (.A(duty[6]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net7));
 sky130_fd_sc_hd__clkbuf_1 input8 (.A(duty[7]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 output10 (.A(net10),
    ...
    .VPWR(VPWR),
    .X(pwm_out));
 sky130_fd_sc_hd__clkbuf_1 wire12 (.A(_17_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
